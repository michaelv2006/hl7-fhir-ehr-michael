...
import uvicorn
from app.controlador.ServiceRequestCrud import GetPatientById,GetPatientByIdentifier,WritePatient,read_service_request,WriteServiceRequest
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://medservice-94k9.onrender.com/servicerequest", "https://hl7-fhir-ehr-michael.onrender.com "],  # Permitir solo este dominio
