...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://write-service-request-mlbj.onrender.com", "https://appointment-sjzy.onrender.com,https://procedures.onrender.com"],  # Permitir solo este dominio
