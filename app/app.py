...
import uvicorn
from app.controlador.PatientCrud import GetPatientById,WritePatient,GetPatientByIdentifier,read_service_request,WriteServiceRequest
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://hl7-patient-write-michael.onrender.com","https://write-service-request-mlbj.onrender.com"],  # Permitir solo este dominio
